...
public enum PlaylistErrorCode implements ErrorCode {
  ...
  PLAYLIST_DUPLICATE_SUBSCRIPTION(5005, "CONFLICT", HttpStatus.CONFLICT, "이미 구독한 플레이리스트입니다."),
  PLAYLIST_SUBSCRIPTION_NOT_FOUND(5006, "NOT_FOUND", HttpStatus.NOT_FOUND, "구독하지 않은 플레이리스트입니다."),
  PLAYLIST_INVALID_CURSOR(5007, "INVALID_CURSOR", HttpStatus.BAD_REQUEST, "유효하지 않은 커서 값입니다."),
  PLAYLIST_SELF_SUBSCRIPTION_NOT_ALLOWED(5008, "CONFLICT", HttpStatus.CONFLICT, "자신의 플레이리스트는 구독할 수 없습니다.");
